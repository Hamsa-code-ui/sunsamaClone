...
export default function DayColumn({ day, projects, openEditor, pendingToggles, onToggleSubtask }: Props) {
    return (
        <div className="day-col">
            ...
            {projects.map((p: Project) => (
                <TaskCard key={p._id} project={p} pendingToggles={pendingToggles} onToggleSubtask={onToggleSubtask} />
            ))}
        </div>
    )
}
