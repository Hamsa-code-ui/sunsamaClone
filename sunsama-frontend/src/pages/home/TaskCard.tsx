...
export default function TaskCard({ project, pendingToggles, onToggleSubtask }: Props) {
        ...
        <div className="task">
            <div className="task-project">
                <div className='task-header'>
                    ...
                    <div className="time-badge">{/* formatTime should be applied outside or included if needed */}{project.plannedTime ?? 0}m</div>
                </div>
                ...
                <div className='task-middlesection'>
                    {project.subtasks?.map((subtask: Subtask, idx: number) => {
                        ...
                        return (
                            <SubtaskItem key={idx} projectId={project._id} subtask={subtask} inFlight={inFlight} onToggle={onToggleSubtask} />
                        )
                    })}
                </div>
